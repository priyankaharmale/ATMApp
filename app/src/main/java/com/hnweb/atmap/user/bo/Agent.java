package com.hnweb.atmap.user.bo;
...
public class Agent {
    ...
    public void setCustomer_bank_name(String customer_bank_name) {
        this.customer_bank_name = customer_bank_name;
    }

    public String getCustomer_acc_num() {
        return customer_acc_num;
    }

    public void setCustomer_acc_num(String customer_acc_num) {
        this.customer_acc_num = customer_acc_num;
    }
    ...
    public String getRouter_number() {
        return router_number;
    }

    public void setRouter_number(String router_number) {
